...
def get_config_dict(input_file_path="C:\\zqhome\\NYU Course\\DBS\\FinalProject\\end2endapp\\config.yaml"):
    with open(input_file_path, 'r') as stream:
        return EasyDict(yaml.safe_load(stream))
    
# Load configuration
config_path = "C:\\zqhome\\NYU Course\\DBS\\FinalProject\\end2endapp\\config.yaml"
